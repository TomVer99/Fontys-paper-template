...
#show: fontys-paper.with(
  ...
  authors-details: (
    "Primary Logistics Department, Delivery Institute, Berlin, Germany",
    "Communications Group, Space Institute, Florence, Italy",
    "Missing Letters Task Force, Mail Institute, Budapest, Hungary",
  ),
  keywords: (
    "Space",
    "Mail",
  ...
  abstract: [
    Recent advances in space-based document processing have enabled faster mail delivery between different planets of a solar system.
    Given the time it takes for a message to be transmitted from one planet to the next, its estimated that even a one-way trip to a distant destination could take up to one year.
    During these periods of interplanetary mail delivery there is a slight possibility of mail being lost in transit.
    This issue is considered so serious that space management employs P.I. agents to track down and retrieve lost mail.
